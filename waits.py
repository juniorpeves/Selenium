...
#Ayuda a hacer referencia a un elemento para interactuar
from selenium.webdriver.support.ui import WebDriverWait
#Hacer uso de las ExpectedCondition con las Esperas explicitas
from selenium.webdriver.support import expected_conditions as EC
#Importanto Esperas Explicitas
...
class ExplicitWaitTests(unittest.TestCase):
    ...
    def test_account_link(self):
        ...
        #Esperara 10seg hasta que se cumpla condición
